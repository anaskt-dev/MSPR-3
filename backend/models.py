...
class Data(Base):
    ...
    # Nombre de nouveaux cas (calculé ou fourni), avec une valeur par défaut de 0.
    new_cases = Column(Integer, default=0)
    # Nombre de nouveaux décès (calculé ou fourni), avec une valeur par défaut de 0.
    new_deaths = Column(Integer, default=0)
    # Nombre de nouveaux cas guéris (calculé ou fourni), avec une valeur par défaut de 0.
